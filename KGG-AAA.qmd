...
```{python}
df_edges_awarded = my_func("AWARDED", "PERSON", "AWARD")[["source", "target", "label"]]
df_edges_discovered = my_func("DISCOVERED", "PERSON", "DISCOVERY")[["source", "target", "label"]]
df_edges_visited = my_func("VISITED", "PERSON", "LOCATION")[["source", "target", "label"]]
df_edges_interpersonal_relationship = my_func("INTERPERSONAL_RELATIONSHIP", "PERSON", "PERSON")[["source", "target", "label"]]
```
